...
Feature: Weborder app login
  ...
  # This is where repeating beginner code can go, this is how to comment in feature file

  Background:
    # This is a shared step for all scenario so that we can remove duplicate
    # by putting it in the Background section of feature
