...
@CucumberOptions(features = "src/test/resources/features",// "classpath:features"
                  glue = "com/cydeo/step_definitions",
                   plugin = { "html:target/cucumber_report.html","pretty",
                           ...
                           "me.jvt.cucumber.report.PrettyReports:target"},// stores the failed scenarios in rerun.txt
                   publish = true, // it will give u the public link of ur local html report
                   dryRun = false,
                   tags = "@ui and @go_home"
)
